...
<table style="width:100%;">
  <tr>
    ...
    <td style="width:50%; text-align:center;">Figure: <br> <i>[1.] Observed vs. expected representation globally.<br> [a.] Political bodies in every country are less representative than expected under a simple random sampling model. <br> [b.] But the model explains much variability in representation.</i></td>
  </tr>
</table>
