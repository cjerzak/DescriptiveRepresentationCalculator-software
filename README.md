...
# Downloading 
You may download via the `devtools` package. In particular, use `devtools::install_github(repo = "cjerzak/ExpectedRepresentationCalculator/ExpectedRepresentation")`
